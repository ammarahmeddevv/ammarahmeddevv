...
**Full-Stack & Mobile Developer** · Karachi, Pakistan · PKT / UTC+5
...
| | |
|---|---|
| **BASE** | Karachi, PK · UTC+5 · remote |
| **FOCUS** | Next.js · TypeScript · Flutter |
...
Where a model sits in the loop — and where it does not.

| Stage | | |
|---|---|---|
| Research | AI | Docs, prior art, API surfaces |
| Architecture | **Me** | Boundaries and data shape |
| Implementation | AI | Scaffolding and first drafts |
| Testing | AI | Cases, fixtures, edge inputs |
| Review | **Me** | Correctness and trade-offs |
| Ship | **Me** | What goes out, and when |

Sessions **45** · Active days **16** · Projects **14** · 2026-08-22 → 2026-09-17
sonnet-5 68.3% · opus-5 31.7%
...
**5** public repositories · **594 kB** of source · last push **2026-09-10**

TypeScript 85.5% · CSS 7.4% · HTML 5.3% · JavaScript 1.8%
